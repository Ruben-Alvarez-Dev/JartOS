...
from src.tests.store import TestStore
from src.tests.generator import TestGenerator, MiniMaxClient
from src.tests.solver import TestSolver
from src.tests.analyzer import TestAnalyzer
...
class TestStoreClass:
    ...
    def store(self, tmp_path):
        ...
        from src.tests.store import TestStore as TS
